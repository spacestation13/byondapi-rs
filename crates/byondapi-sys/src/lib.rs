...
impl ByondApi {
    ...
    #[cfg(any(feature = "byond-515-1620"))]
    pub unsafe fn ByondValue_Clear(&self, value: *mut CByondValue) {
        self.internal.ByondValue_Clear(value)
    }
    #[cfg(any(
        feature = "byond-515-1609",
        feature = "byond-515-1610",
    ...
    #[cfg(any(feature = "byond-515-1620"))]
    pub unsafe fn ByondValue_IsTrue(&self, value: *const CByondValue) -> bool {
        self.internal.ByondValue_IsTrue(value)
    }
    ...
    pub unsafe fn ByondValue_SetStr(
        &self,
        value: *mut CByondValue,
        str_: *const ::std::os::raw::c_char,
    ) {
        self.internal.ByondValue_SetStr(value, str_)
    }
    #[cfg(any(
        feature = "byond-515-1609",
        feature = "byond-515-1610",
    ...
    #[cfg(any(feature = "byond-515-1617", feature = "byond-515-1620"))]
    ...
    pub unsafe fn Byond_ToString(
        ...
        self.internal.Byond_ToString(src, buf, buflen)
    }
    #[cfg(any(feature = "byond-515-1620"))]
    pub unsafe fn Byond_Block(
        ...
        self.internal.Byond_Block(corner1, corner2, list, len)
    }
    #[cfg(any(
        feature = "byond-515-1610",
        feature = "byond-515-1611",
    ...
    pub unsafe fn Byond_Refcount(&self, src: *const CByondValue, result: *mut u4c) -> bool {
        self.internal.Byond_Refcount(src, result)
    }
    #[cfg(any(feature = "byond-515-1611", feature = "byond-515-1617"))]
